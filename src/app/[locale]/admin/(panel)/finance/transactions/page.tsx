  ...
  return (
    <CashTransactionsManager
      ...
      labels={{
        ...
        counterpartySelectPlaceholder: dictionary.admin.financeCashTransactionsCounterpartySelectPlaceholder,
        counterpartyEmpty: dictionary.admin.financeCashTransactionsCounterpartyEmpty,
