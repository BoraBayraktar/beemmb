...
export default async function AdminFinanceIncomeExpenseReportPage({
  params,
  searchParams,
}: {
  ...
  const report = await reportsService.getIncomeExpenseReport(locale, {
    from: range.fromIso,
    to: range.toIso,
