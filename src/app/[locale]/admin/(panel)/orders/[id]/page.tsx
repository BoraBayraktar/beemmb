  ...
  return (
    <OrderDetailManager
      ...
      labels={{
        ...
        financialMovementSourceManual: dictionary.admin.financeCashTransactionsManual,
        financialMovementSourceCollection: dictionary.admin.financeCashTransactionsCollection,
        financialMovementSourcePayment: dictionary.admin.financeCashTransactionsPayment,
        financialMovementSourceOrder: dictionary.admin.financeCashTransactionsOrder,
        financialMovementSourceDocument: dictionary.admin.financeCashTransactionsDocument,
        financialMovementSourceRefund: dictionary.admin.financeCashTransactionsRefund,
        financialMovementSourceTransfer: dictionary.admin.financeCashTransactionsTransfer,
