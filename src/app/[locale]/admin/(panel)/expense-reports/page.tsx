  ...
  return (
    <ExpenseReportManager
      ...
      copy={{
        ...
        statusReturned: admin.expenseReportStatusReturned,
        resubmit: admin.expenseReportResubmit,
        approvalFlowTitle: admin.expenseReportApprovalFlowTitle,
        approvalStepApproved: admin.expenseReportApprovalStepApproved,
        approvalStepCurrent: admin.expenseReportApprovalStepCurrent,
