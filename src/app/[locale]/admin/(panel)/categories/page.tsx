  ...
  return (
    <CategoryManager
      ...
      labels={{
        ...
        featureTemplateTitle: dictionary.admin.categoryFeatureTemplate,
        featureTemplateHint: dictionary.admin.categoryFeatureTemplateHint,
        featureTemplateAdd: dictionary.admin.categoryFeatureTemplateAdd,
        featureTemplatePlaceholder: dictionary.admin.categoryFeatureTemplatePlaceholder,
        featureTemplateEmpty: dictionary.admin.categoryFeatureTemplateEmpty,
