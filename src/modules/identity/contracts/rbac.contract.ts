...
export const RBAC_SYSTEM_ROLES = [
  ...
  },
  {
    ...
    permissions: ["admin.access", "audit.read", "products.read", "orders.read", "inventory.read", "documents.read", "incomingInvoices.read", "finance.read", "integrations.read"],
    legacyRoles: [],
  },
  {
    key: "finance",
    ...
    permissions: ["admin.access", "orders.read", "documents.read", "incomingInvoices.read", "incomingInvoices.manage", "finance.read", "finance.manage", "finance.audit.read"],
    legacyRoles: [],
  },
  {
    key: "accountant",
    ...
    permissions: ["admin.access", "documents.read", "incomingInvoices.read", "incomingInvoices.manage", "finance.read", "finance.audit.read"],
    legacyRoles: [],
  },
  {
    key: "catalog-manager",
